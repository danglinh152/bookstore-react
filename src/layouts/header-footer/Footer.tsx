                ...
                <footer className="py-5">
                    ...
                    <div className="d-flex flex-column flex-sm-row justify-content-between py-3 my-3 border-top">
                        ...
                        <ul className="list-unstyled d-flex">
                            ...
                            <li className="ms-3"><a className="link-body-emphasis" href="#"><i className="fa-brands fa-instagram text-light fs-5"></i></a></li>
                            <li className="ms-3"><a className="link-body-emphasis" href="#"><i className="fa-solid fa-envelope text-light fs-5"></i></a></li>
                        </ul>
                    </div>
                </footer>
            </div>
