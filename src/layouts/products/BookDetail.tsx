    ...
    return (
        <div className="container-fluid">
            <div className="container p-5">
                <div className="row">
                    <div className="col-3 p-2 rounded bg-white sticky-top" style={{ height: '530px' }}>
                    ...
                    <div className="col-6">
                        <div className="bg-white rounded me-2 p-3 mb-2">
                            <h4 className="fs-5 fw-bold line-clamp">{book?.getTitle()}</h4>
                        ...
                        <div className="bg-white rounded mt-3 me-2 p-3">
                            <p className="fs-4"> Thông tin vận chuyển </p>
                            <p className="fs-6"> Giao đến abcxyz </p>
                        </div>
                        <div className="bg-white rounded mt-3 me-2 p-3">
                            <p className="fs-4"> Thông tin vận chuyển </p>
                            <p className="fs-6"> Giao đến abcxyz </p>
                    ...
                    <div className="col-3 d-flex flex-column gap-2 bg-white rounded p-2 sticky-top" style={{ height: '300px' }}>
